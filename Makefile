...
ELABORATE_FILE_S3 := s3://$(STATE_BUCKET)/$(ADAPTER_DOMAIN_NAME)/hub/eks-adapter/hub.elaborate
ELABORATE_FILES   := $(ELABORATE_FILE_FS),$(ELABORATE_FILE_S3)
STATE_FILES       := .hub/$(ADAPTER_DOMAIN_NAME).state,s3://$(STATE_BUCKET)/$(ADAPTER_DOMAIN_NAME)/hub/eks-adapter/hub.state
